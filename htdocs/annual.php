...
<div id="template_main">
  ...
  <div id="content_wrap">
    ...
    <div id="content-inner">
      	...
      	The period for the annual results is April 01 to March 31 every year. To view the reports, click on the respective report below:<br />
        <br />
	  	<?php
		$reqdyear = date('Y') - 1;
		$comp_results_sql = "SELECT * FROM sci_comp_results where sci_results_type='Annual'";
		$comp_results_rs = mysql_query($comp_results_sql);
		
		while($comp_results_arr=mysql_fetch_array($comp_results_rs))
		{
		?>
        	<a href="viewpdf.php?resulttype=Annual&year=<?php echo $comp_results_arr['sci_year']; ?>" <?php if(isset($_SESSION['user'])) { ?>target="_blank"<?php } ?>><span class="yellow"> >> </span> <?php echo $comp_results_arr['sci_year']; ?></a><br />
		<?php
		}
		?>
	</div>
