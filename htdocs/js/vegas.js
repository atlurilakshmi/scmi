...
(function($) {
    ...
    Vegas.prototype = {
        ...
        _slideShow: function() {
            ...
            /// var text = ["Welcome 1", "Welcome 2", "Welcome 3"];
            if (this.total > 1 && !this.ended && !this.paused && !this.noshow) {
                this.timeout = setTimeout(function() {

                    if (self.slide == text.length - 1) {
                        elem.innerHTML = text[0];
                    } else {
                        elem.innerHTML = text[self.slide + 1];
                    }
        ...
        _goto: function(nb) {
            ...
            if (this.support.video && videoSettings) {
                ...
                $inner = $('<div class="vegas-slide-inner"></div>').html(overlaytext)
