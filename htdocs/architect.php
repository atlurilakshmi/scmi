...
<embed src="flash/logo.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="205" height="76" wmode="transparent"></embed>
      ...
      <div id="navi_mnu">
        <ul id="nav" class="dropdown dropdown-vertical">
<li class="cur_main_mnu"><a href="architect.php" target="_self"><span class="let_big">a</span>rchitectures</a>
<ul>
...
<li><a href="industry.php" target="_self"><span class="let_big">i</span>ndustry of <span class="let_big">f</span>ashion</a>
 <ul>
                ...
                <div style="border-bottom:1px solid #828283; margin: 5px 0;"></div>
                <h2><big>P</big>IPELINE <big>P</big>ROJECTS</h2>
                <li><a href="goldlip.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<big>G</big>OLD <span class="let_big">L</span>IP <span class="let_big">HFC</span></a></li>  <li><a href="alba.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<big>A</big>lba<big>.T.K.</big> </a></li>
              </ul>
</li>
  ...
  <div id="content_wrap">
    <div id="content-inner">
      <h2>ARCHITECTURES </h2>
	  SCIMORES Architectures will be one of the most luxurious real estate super-brand recognized globally.   We will be focusing on posh residential, commercial, and infrastructural projects presenting the highest level of excellence and luxury. <br />
<br />
The experience of owning Scimores property and living the Scimores lifestyle will be unparalleled.  One will see the touch of the Scimores brand in every aspect – from the cutting edge design created in collaboration with the world’s best architects, to the flawless interiors designed specifically for each market, to the world-class service with no detail overlooked.  With each property, we will raise the bar of super luxury consistently.
