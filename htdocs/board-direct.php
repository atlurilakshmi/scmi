...
<div id="template_main">
  ...
  <div id="content_wrap">
    <div id="content-inner">
	  ...
	  <img src="images/bodir.jpg" border="0" />
      <!-- table cellpadding="0" cellspacing="0" border="0" class="bod">
        <tr>
          <td></td>
          <td class="bod-box"><span class="bod-box-head">Hemanth Kumar Balasundaram<br />
            </span>Branding, Marketing, Finance, Corporate Operation, Strategy Portfolio</td>
          <td></td>
        </tr>
        <tr>
          <td class="bod-s">&nbsp;</td>
        ...
        <tr>
          <td align="center" valign="middle" class="bod-box"><span class="bod-box-head">Anju Hemanth</span><br />
          Business & Corporate Programs</td>
          <td rowspan="7" align="center"><img src="images/goldlip.gif" /></td>
          <td class="bod-box"></td>
        </tr>
        <tr>
          <td class="bod-box-space">&nbsp;</td>
          <td></td>
        </tr>
        <tr>
          <td class="bod-box"><span class="bod-box-head">Shashi Devendran </span><br />
            Business &amp; Legal Affairs</td>
          <td class="bod-box"></td>
        </tr>
        <tr>
          <td class="bod-box-space">&nbsp;</td>
        ...
        <tr>
          <td class="bod-box"><span class="bod-box-head">Shiva Kumar Balasundaram</span><br />
            Foreign Investment &amp; Ops</td>
          <td class="bod-box"></td>
        </tr>
        <tr>
          <td class="bod-box-space">&nbsp;</td>
