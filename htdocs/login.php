        ...
        <ul id="nav" class="dropdown dropdown-vertical">
          <li ><a href="overview.php" target="_self" title="Company"><span class="let_big">C</span>ompany</a>
              <ul>
                ...
                <!-- heading -->
                <li><a href="recreat.php"><span class="let_big">C</span>OMPANY <span class="let_big">P</span>ROFILE</a>
                    <ul>
                ...
                <li><a href="recreat.php"><span class="let_big">R</span>ESULTS</a>
                    <ul>
                ...
                <!-- heading -->
                <li class="dir"><a href="recreat.php"><span class="let_big">S</span>HARES</a>
                    <ul>
                ...
                <li><a href="recreat.php"><span class="let_big">C</span>ORPORATE <span class="let_big">G</span>OVERNANCE</a>
                    <ul>
                      ...
                      <li><a href="article-asso.php"><span class="let_big">A</span>rticle <span class="let_big">o</span>f <span class="let_big">A</span>ssociation</a></li>
                    </ul>
                </li>
