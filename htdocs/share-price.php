...
<div id="template_main">
  ...
  <div id="content_wrap">
    <div id="content-inner">
      <h2>Share Price</h2>
      <img src="images/share_price.gif" border="0"/>
	  <div class="overview">
	  <br />The graph presented above is based on our internal assessment, and would be the estimated market price at the time of IPO, which we are planning in FY 2013-2014. Shares Certificates issued in the interim will be converted to DMAT at the time of IPO.
	  </div>
	</div>
  </div>
