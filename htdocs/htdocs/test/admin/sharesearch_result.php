...
Purchase price will be fixed to face value of INR 25 a share during the issue open period.</td>
		...
		$paymentinfo="<tr>
					  ...
					  <tr>
						<td style=\"font-family:Tahoma; font-size:12px; font-weight:bold\">Beneficiary Bank SWIFT Code</td><td style=\"font-family:Tahoma; font-size:12px; font-weight:normal\">: CITIINBX</td>
					  </tr>
					  <tr>
						<td style=\"font-family:Tahoma; font-size:12px; font-weight:bold\">Purpose of Transfer</td><td style=\"font-family:Tahoma; font-size:12px; font-weight:normal\">: Share Subscription</td>
					  </tr>
					  <tr>
						<td style=\"font-family:Tahoma; font-size:12px; font-weight:normal; text-align:justify\" colspan=2><br>For transfers from outside of India, your remitting bank may ask for your local intermediary Bank Swift Code. Please refer to the below table for respective SWIFT Codes.</td>
					  </tr>
					  <tr>
...
INR if they are in USD, GBP, EURO or SD.</td>
					  ...
					  <tr>
					  	<td colspan=2>
					  		<table width=\"200\" style=\"color:#0000FF\">
							  <tr>
		...
		if($_POST['action'] == 'allot')
		{
			...
			$HTML="<html>
				...
				<table style=\"font-family:Tahoma\" width=\"500\" align=\"center\">
					  ...
					  <tr>
						<td style=\"font-family:Tahoma; font-size:12px; font-weight:normal; text-align:justify\" colspan=2><br>The following shares have been allotted towards your above request. Kindly remit your payment towards your shares, and email a scanned copy of the attached Share Application (completed and signed), along with a copy of the 1st page and last page of your passport.<br><br></td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						<td style=\"font-family:Tahoma; font-size:12px; font-weight:normal; padding-left:38px\">Application</td><td style=\"font-family:Tahoma; font-size:12px; font-weight:normal\">= INR ".number_format($application)."</td>
					  </tr>
					  <tr>
						<td style=\"font-family:Tahoma; font-size:12px; font-weight:normal; padding-left:38px\">Allotment</td><td style=\"font-family:Tahoma; font-size:12px; font-weight:normal\">= INR ".number_format($allotment)."</td>
					  </tr>
<tr>
						<td style=\"font-family:Tahoma; font-size:12px; font-weight:normal; padding-left:38px\">1st Call</td><td style=\"font-family:Tahoma; font-size:12px; font-weight:normal\">= INR ".number_format($firstcall)."</td>
					  </tr>
<tr>
						<td style=\"font-family:Tahoma; font-size:12px; font-weight:normal; padding-left:38px\">2nd Call</td><td style=\"font-family:Tahoma; font-size:12px; font-weight:normal\">= INR ".number_format($secondcall)."</td>
					  </tr>
<tr>
						<td style=\"font-family:Tahoma; font-size:12px; font-weight:normal; padding-left:38px\">3rd Call</td><td style=\"font-family:Tahoma; font-size:12px; font-weight:normal\">= INR ".number_format($thirdcall)."</td>
					  </tr>
					  <tr>
			...
			$mailheaders .= "MIME-Version: 1.0\r\n";
			$mailheaders .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
			mail($useremail, $subject, $HTML, $mailheaders);
...
$shares_sql .= " ORDER BY sci_request_id DESC";
//echo $shares_sql;
...
<div id="content_wrapper_full">
    ...
    <table cellpadding="3" cellspacing="0" class="port_tbl_full">
        <tr>
          <td colspan="16">&nbsp;</td>
          <td colspan="3" align="center">
		  <div id="port_manage_butt"><a href="sharesearch.php" target="_self">BACK TO SEARCH</a></div></td>
        </tr>
		<tr><td colspan="19"><div class="err_msg"><?php echo $statusmsg; ?></div></td></tr>
		<?php if($shares_num > 0) { ?>
		<tr>
		...
		<?php } else { ?>
		<tr><td colspan="19"><div id="errmsg" class="err_msg">No records found matching the Search Criteria.</div></td></tr>
	  ...
	  <td class="port_content" align="right"><?php echo number_format($shares_arr['sci_application']); ?></td>
	  <td class="port_content" align="right"><?php echo number_format($shares_arr['sci_allotment']); ?></td>
	  <td class="port_content" align="right"><?php echo number_format($shares_arr['sci_1stcall']); ?></td>
	  <td class="port_content" align="right"><?php echo number_format($shares_arr['sci_2ndcall']); ?></td>
	  <td class="port_content" align="right"><?php echo number_format($shares_arr['sci_3rdcall']); ?></td>
