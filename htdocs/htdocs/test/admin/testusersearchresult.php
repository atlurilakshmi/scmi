...
if(count($_POST['usersid']) > 0)
{
	foreach($_POST['usersid'] as $userid)
	{
		...
		{
		header('Location: edituser.php?userid='.$userid); exit;
		}
...
<div id="content_wrapper">
	...
	<input type="submit" name="action" value="EDIT" class="formbutton" />
		<input type="submit" name="action" value="DELETE" class="formbutton" onclick="return confirm('Are you sure want to delete the request(s)?');" />
		</td>
        ...
        <tr>
          ...
          <td class="port_content" align="left"><?php echo $users_arr['sci_country']; ?></td>
		  <td class="port_content" align="left"><?php echo $users_arr['sci_state']; ?></td>
