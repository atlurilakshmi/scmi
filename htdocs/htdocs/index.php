...
<head>
    ...
    #navi_wrapper {
        background: url(../images/shadow_bg.png) center repeat;
        float: left;
        height: auto;
...
<body>
    <div class="company_backdrop">
        <div id="template_main">
                   ...
                   <!--     <span class="gold-label">  Gold Lip</span>
                        ...
                        <br>
                         <div style="text-align:center">                               
                            ...
                            <div><span class="space_line">&nbsp;</span></div>                        
                        <span class="Academy_end_text">In Pre-Construction Phase. Click the below icon</span>
                        <br>
                        <span class="Academy_end_text"> to view the Plan/Brochure.</span>
            ...
            msg1 += '<br>';
            msg1 += '<div style="text-align:center"><span class="scimores_cap_word">C</span><span class="scimores_secondLine">HENNAI, </span> <span class="scimores_cap_word">I</span><span class="scimores_secondLine">NDIA</span></div>';
            msg1 += '<span class="space_line">&nbsp;</span>';
            msg1 += '<br>';
            msg1 += '<span class="space_line"></span>';
            msg1 += '<span class="scimores_endLine">In Planning Phase. Click the below icon to view</span>';
            msg1 += '<br>';
            msg1 += '<span class="Academy_end_text">the Plan.</span>';
            msg1 += '</div>';
            ...
            msg2 += '<br>';
            msg2 += '<div style="text-align:center"><span class="scimores_cap_word">C</span><span class="scimores_secondLine">HENNAI, </span> <span class="scimores_cap_word">I</span><span class="scimores_secondLine">NDIA</span></div>';
            msg2 += '<span class="space_line">&nbsp;</span>';
            msg2 += '<br>';
            msg2 += '<span class="scimores_endLine">In Planning Phase. Will be publishing the plan </span>';
            msg2 += '<br>';
            msg2 += '<span class="scimores_endLine">very soon.</span>';
            msg2 += '</div>';
            ...
            msg3 += '<span class="space_line">&nbsp;</span>';
            msg3 += '<br>';
            msg3 += '<span class="Academy_end_text">In Pre-Construction Phase. Click the below icon</span>';
            msg3 += '<br>';
            msg3 += '<span class="Academy_end_text">to view the Plan/Brochure.</span>';
            msg3 += '</div>';
