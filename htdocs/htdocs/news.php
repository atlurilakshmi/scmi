            ...
            <div id="content_wrap">
                <div id="content-inner">
                   ...
                   <div class="data-class1">
                    ...
                    <div class="data-class1">
                              <span class="item-space"> <a href="http://icare.fairfaxcounty.gov/ffxcare/search/commonsearch.aspx?mode=address" target="_blank"  <?php if(isset($_SESSION[ 'user'])) { ?>target="_blank"<?php } ?> class="yellow">http://icare.fairfaxcounty.gov/ffxcare/search/commonsearch.aspx?mode=address</a></span>
                    </div> 
                    ...
                    <div  class="data-class2">                              
                        <table>                      
                         ...
                         <tr>
                              <td>2625</td>
                              <td id="right-ali">Centreville</td>
                          </tr>
                             <tr>
                             <td>2633</td>
                             <td id="right-ali">Centreville</td>
                    ...
                    2017-07-19 <span class="item-space">  <a href="https://1drv.ms/b/s!AvqYzV17v_FxoEGRN4lgs0gdTGU8" target="_blank" <?php if(isset($_SESSION[ 'user'])) { ?>target="_blank"<?php } ?> class="yellow">Site Plan</a> Submitted to DPZ</span>
                    </div> 
