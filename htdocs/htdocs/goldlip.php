...
<div class="intl_button">
  ...
  <img src="images/visit-website.gif" alt="visit website" border="0" height="20"/>
</a>
<a href="viewpdf.php?project=goldlip" <?php if(isset($_SESSION['user'])) { ?>target="_blank"<?php } ?>>
<img src="images/viewplan.gif" alt="view plan" border="0" height="20" /></a>
<a href="industry.php">
  <img src="images/view_all.gif" alt="view all" border="0" height="20"/>
</a>
</div>
<!--
