  ...
  <div id="content_wrap">
    <div id="content-inner-2">
      ...
      <ul>
        <li><b>Company</b>
          <ul>
            <li><a href="overview.php"><b>Overview</b></a></li>
            <li><b>Company Profile</b></b>
              <ul>
                <li><a href="fact-sheet.php">Fact Sheet</a></li>
                <li><a href="organization-stru.php">Organization Chart</a></li>
                <li><a href="managemanent-pro.php">Management Profiles</a></li>
            ...
            <li><b>Shares</b>
              <ul>
                ...
                <li><a href="shareholding-patt.php">Shareholding Pattern</a></li>
                <li><a href="analyst-cov.php">Analyst  Coverage</a></li>
                <li><a href="my-port.php">My Portfolio</a></li>
              </ul>
            </li>
            <li><b>Corporate Governance</b>
              <ul>
                <li><a href="board-direct.php">Board of Directors</a></li>
                <li><a href="memorandum-asso.php">Memorandum of Association</a></li>
                <li><a href="article-asso.php">Articles of Association</a></li>
              </ul>
            </li>
            <li><a href="conferences-event.php"><b>Conferences & Events</b></a></li>
            <li><a href="investor-supp.php"><b>Investor Support</b></a></li>
          </ul>
        </li>
        <li><a href="architect.php"><b>Architectures</b></a></li>
        <li><a href="recreat.php"><b>Recreation & Hotels</b></a></li>
        <li><a href="industry.php"><b>Industry of Fashion</b></a></li>
        <li><a href="education.php"><b>Educational Sector</b></a></li>
        <li></li>
      </ul>
      <ul>
        <li><a href="news.php"><b>News & Announcements</b></a></li>
	  ...
	  <li></li>
	  <li><a href="login.php">Members Login</a> | <a href="register.php">Register</a></li>
	  </ul>
	  </div>
	  </div>
    </div>
